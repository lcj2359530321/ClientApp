...
/**
 * https://github.com/sharp-edge/ComposePinInput
 */
@OptIn(ExperimentalComposeUiApi::class)
@Composable
public fun MyPinInput(
    value: String,
    ...
    cellShape: Shape = MaterialTheme.shapes.extraSmall,
    fontColor: Color = Color.LightGray,
    cellBorderColor: Color = Color.Gray,
    rowPadding: Dp = SpaceExtraMedium,
    cellPadding: Dp = SpaceOuter,
    cellSize: Dp = 50.dp,
    cellBorderWidth: Dp = SpaceExtraSmall,
